...
class PromotionController extends AbstractController
{
    ...
    /**
     * @Route("resto/promotion/search/{id}", name="search_id", methods={"GET"})
     */
   ...
   *
   * @Route("resto/promotion/search", name="ajax_search")
   * @Method("GET")
   */
  ...
  public function getRealEntities($promotion){
    ...
    /**
     * @Route("resto/promotion/detail/{id}", name="show_front", methods={"GET"})
     */
